    ...
    >
      ...
      <section id="hero" className="relative pt-32 pb-20 px-6 min-h-[90vh] flex flex-col items-center justify-center z-10 overflow-hidden">
        ...
        <div className="text-center max-w-5xl mx-auto relative z-20">
          ...
          >
            <RainbowButton onClick={() => navigate('/pricing')}>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <ScrollReveal>
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              ...
              <Button variant="secondary" onClick={() => navigate('/pricing')} className="border-white/20 hover:border-white/50 bg-white/5 hover:bg-white/10">Start Now</Button>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <ScrollReveal delay={0.2}>
              <ServiceCard
                title="Scout AI"
                subtitle="Professional Architectural Visualization & Interior CAD AI - Convert 2D floor plans to colored presentation-ready plans."
                icon={Calculator}
                glowColor="purple"
                onExpand={() => navigate('/scout')}
                badge="Coming Soon"
              />
            </ScrollReveal>
              ...
              <div className="pt-2 text-center">
                {activeModal === 'ipad' && (
                  <div>
                    ...
                    <Button onClick={() => navigate('/pricing')} className="w-full">Get Started</Button>
                  </div>
                )}
              </div>
            </motion.div>
